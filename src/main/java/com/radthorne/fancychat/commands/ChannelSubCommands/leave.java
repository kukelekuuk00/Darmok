...
public class leave implements SubCommand
{
    ...
    public void player( Player sender, String label, String[] args )
    {
        ...
        if ( args.length < 1 )
        {
            sender.sendMessage( FancyChat.messenger.playerError( "You must provide a channel to leave, like /ch leave g" ) );
            return;
        }
        ...
        try
        {
            FancyChat.getPlayerRegistry().getPlayerChannels( sender ).leaveChannel( channel );
        }
        ...
        sender.sendMessage( FancyChat.messenger.playerHeaderMsg( "You have left " + channel.getName() + " channel." ) );
    }
    ...
    {
        return "fancychat.commands.channel.leave";
    }
